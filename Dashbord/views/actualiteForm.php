...
<?php
    ...
    if (
        ...
        if (
            ...
            mail('ayed.mohamedaziz@esprit.tn','Un Ajout au table Actualite','Une nouvelle entite Actualite est ajouter il y a quelques secondes ','From: ayed.mohamedziz@esprit.tn');
                ...
                <div id="layoutSidenav_content">
                    <div class="testbox">
                        <form action="" method="POST">
                          ...
                          <div >
                            <input type="text" name="TitreActualite" id="TitreActualite" placeholder="exemple: Exposer inatendue" required maxlength = "40"/>
                          </div>
                          ...
                          <textarea rows="5" id="DescriptionActualite" name="DescriptionActualite" required maxlength = "1400"></textarea>
