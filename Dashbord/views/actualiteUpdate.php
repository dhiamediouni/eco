    ...
    <body class="sb-nav-fixed">
		...
		?>
                        <form action="" method="POST">
                          ...
                          <div class="date">
                            <input type="date" name="DateActualite" id="DateActualite" value="<?php echo $Actualite ['DateActualite']?>"required/>
                            <i class="fas fa-calendar-alt"></i>
                          </div>
                          <h4>Description Actualite</h4>
                          <textarea rows="5" id="DescriptionActualite" name="DescriptionActualite"  required><?php echo $Actualite ['DescriptionActualite']?></textarea>
                          <h4>Select image to upload:</h4>
                          <input type="file" name="ImageActualite" id="ImageActualite" value="<?php echo $Actualite ['ImageActualite']?>" >
                          <div class="btn-block">
