	...
	function chkSubmit() {
			...
			var textmsg = $.trim($(msg).text());
				...
				if (textmsg == '') {
					...
					//alert('nogo');
					$('.error').show();
					$('.error').html('Please fill out something in the comments box');
					return false;
				}
				else{
					//alert(textmsg);
...
$jscomp.polyfill("Array.from", function (b) {
    return b ? b : function (b, d, p) {
        ...
        if ("function" == typeof n) {
            b = n.call(b);
            for (var r = 0; !(n = b.next()).done;) h.push(d.call(p, n.value, r++))
        } else
...
(function () {
    ...
    function D(a) {
        ...
        a.querySelectorAll(".carousel-inner").forEach(function (a) {
            a.setAttribute("class", "carousel-inner slides" + c)
        });
        a.querySelectorAll(".clonedCol").forEach(function (a) {
            a.remove()
        });
        a.querySelectorAll(".carousel-item .col-md-12").forEach(function (a) {
            2 > c ? a.setAttribute("class", "col-md-12") : "5" == c ? a.setAttribute("class", "col-md-12 col-lg-15") : a.setAttribute("class", "col-md-12 col-lg-" + 12 / c)
        });
    ...
    Element.prototype.parents =
        function (a) {
            for (var b = [], c = this, d = void 0 !== a; null !== (c = c.parentElement);) c.nodeType === Node.ELEMENT_NODE && (d && !c.matches(a) || b.push(c));
            return b
        };
    Element.prototype.footerReveal = function () {
        function a() {
            !c && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "")
        }
        var b =
...
! function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.in">Mobirise</a> Mobirise v5.5.0';
